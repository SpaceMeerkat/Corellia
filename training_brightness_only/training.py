...
save_directory = '/home/corona/c1307135/Semantic_ML/Corellia/images/sbprof_only/'
...
def training(model:torch.nn.Module,batch_size,epochs,loss_function,initial_lr,
    ...
    for epoch in range(epochs):
        ...
        if (save_dir is not None) and (epoch == epochs-1):
            plotter(prediction, mom0s, save_directory)
        ...
        if (model_dir is not None) and (epoch == epochs-1):
            torch.save(model.state_dict(),model_dir+'sbprof_only.pt')  

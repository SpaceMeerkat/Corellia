...
class KinMS:
    ...
    def smoothmask(self,cube,FluxThresh):
        ...
        mask /= mask.max()
        mask[mask < FluxThresh]=0
        mask[mask > 0] =1
        return mask
        
    def model_cube(self, FluxThresh=None, masking=False, toplot=False):
        """
...
# =============================================================================
#         Adding in a convolution for smooth masking
# =============================================================================
        
        if masking == True:
            
            mask = self.smoothmask(cube,FluxThresh)
            cube *= mask
